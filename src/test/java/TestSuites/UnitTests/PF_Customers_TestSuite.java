 ...
 */
public class PF_Customers_TestSuite {
    static TestMarshall instance;
    public static Enums.DeviceConfig test;

    public PF_Customers_TestSuite() {
    ...
    public void CreateAnOpportunityFromCustomerList() throws FileNotFoundException {
        ...
        instance = new TestMarshall("TestPacks/Customers/PF/Create an opportunity from customer list-TestPack.xlsx", Enums.BrowserType.FireFox, false);
    ...
    public void DownloadCustomerInsights() throws FileNotFoundException {
        Narrator.logDebug("DAE| Customers");
        instance = new TestMarshall("TestPacks/Customers/PF/Download Insights-TestPack.xlsx", Enums.BrowserType.FireFox, false);
        instance.runKeywordDrivenTests();
    }
    ...
    public void PreviewCustomerInsights() throws FileNotFoundException {
        Narrator.logDebug("DAE| Customers");
        instance = new TestMarshall("TestPacks/Customers/PF/Preview Insights-TestPack.xlsx", Enums.BrowserType.FireFox, false);
        instance.runKeywordDrivenTests();
    }
