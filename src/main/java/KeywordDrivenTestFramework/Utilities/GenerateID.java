...
public class GenerateID {
    ...
    private String gender; //the gender to spesift
    ...
    private String id= "";
    private int ageMin; //Minimum age to be spesified in comments
    private int ageMax; //Maximum age to be spesified in comments
    ...
    private String getDateOfBirth() {
        ...
        int dayOfYear = getRandBetween(1, gc.getActualMaximum(gc.DAY_OF_YEAR));
        int yearMinus = 1900;
        ...
        dateOfBirth = Integer.toString((gc.get(gc.YEAR)) - yearMinus);
        if (dateOfBirth.length() == 1) { //Adds a 0 if there is only one position
            dateOfBirth = "0" + dateOfBirth;
        }

        int genMonth = getRandBetween(1, gc.getActualMaximum(gc.MONTH));
        ...
        int genDay = getRandBetween(1, gc.getActualMaximum(gc.DAY_OF_MONTH));
        ...
        csvOutput = Integer.toString((gc.get(gc.YEAR))) + ",";
        csvOutput += month + ",";
        csvOutput += day;
